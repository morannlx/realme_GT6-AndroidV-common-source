...
#define HIGH_ORDER_GFP ((GFP_HIGHUSER | __GFP_ZERO | __GFP_NOWARN | __GFP_COMP \
...
/* increase benchmark memory performance */
bool chp_anon_always __read_mostly = false;
					 ...
					 struct file *filp, unsigned long pgoff)
{
	...
	/* don't change alignment for 32bit non-file pages or len <= PAGE_SIZE*/
 ...
 * gfp_t gfp_mask = (GFP_TRANSHUGE_LIGHT | __GFP_RECLAIM) & ~__GFP_MOVABLE;
 *
 * 2) Allow kswapd reclaim
 * gfp_mask = (GFP_TRANSHUGE_LIGHT  | __GFP_KSWAPD_RECLAIM) & ~__GFP_MOVABLE;
 *
 * 3) Not allowed to reclaim
 * gfp_mask = GFP_TRANSHUGE_LIGHT & ~__GFP_MOVABLE;
 *
 * <- kernel ->
...
static int __init cmdline_parse_prjname(char *p)
{
	static const char *prjs[] = {
		"23867", "23868", "23869", "22825", "22877", "22111", "23607", "23803", "23609", "23622", "23718",
		"23814", "22112", "24687", "23631", "23927", "23926", "23978", "23976", "24211", "24212", "24607", "24697",
		"24698", "24623", "24724",
		"24616", "24718", "24719", "24732", "24733", "24738", "24743", "24744", "24612", "24621", NULL,
	};
	static const char *ext_prjs[] = {
		"23867", "23868", "23869", "22877", "23718", "24687", "24672", "23978", "23976", "24211",
		"24212", "24697", "24698", "24623", "24724",
		"24718", "24719", "24732", "24733", "24738", "24743", "24744", NULL, /* FIXME: add projects which don't support art alignment */
	};
			     ...
			     const char *buf, size_t count)
{
	...
	/*
	 * if alwasy is on, all anon vma could be a chp vma, which means
	 * vma_is_chp_anonymous always true.
	 */
	if (sysfs_streq(buf, "always")) {
		chp_anon_always = true;
		ret = count;
	} else if (sysfs_streq(buf, "always_off")) {
		chp_anon_always = false;
		ret = count;
	}
	return ret;
}
